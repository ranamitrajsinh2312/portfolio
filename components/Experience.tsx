      ...
      <div className="container-custom" ref={ref}>
        ...
        <div style={{ position: "relative", paddingLeft: "36px", maxWidth: "720px" }}>
          ...
          >
            ...
            <div style={{ fontSize: "11px", color: "var(--text3)", marginBottom: "8px", fontWeight: 500, letterSpacing: "1px", textTransform: "uppercase" }}>
              2024 · Certified
            </div>
            ...
            <div style={{ fontSize: "14px", color: "var(--accent2)", marginBottom: "20px" }}>
